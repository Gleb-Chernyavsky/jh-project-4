...
describe('Service Tests', () => {
  describe('Goods Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Goods(0, 'AAAAAAA', 0, 'image/png', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Goods', async () => {
      ...
      it('should not update a Goods', async () => {
      ...
      it('should not return a list of Goods', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a Goods', async () => {
