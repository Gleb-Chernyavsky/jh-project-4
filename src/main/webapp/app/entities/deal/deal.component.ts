...
export default class Deal extends mixins(JhiDataUtils, AlertMixin) {
  ...
  public prepareRemove(instance: IDeal): void {
  ...
  public removeDeal(): void {
    this.dealService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('jhProject4App.deal.deleted', { param: this.removeId });
