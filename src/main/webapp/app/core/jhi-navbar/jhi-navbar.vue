<template>
    <b-navbar toggleable="md" type="dark" class="jh-navbar">
        <b-navbar-brand class="logo" b-link to="/">
            ...
            <span v-text="$t('global.title')" class="navbar-title">jhProject4</span> <span class="navbar-version">{{version}}</span>
        </b-navbar-brand>      
        <b-navbar-toggle 
        right 
            ...
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/goods">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.goods')">Goods</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/category">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.category')">Category</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/deal">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.deal')">Deal</span>
                    </b-dropdown-item>
