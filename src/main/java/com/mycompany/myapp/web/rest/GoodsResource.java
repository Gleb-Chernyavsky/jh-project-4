...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Goods}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class GoodsResource {
    ...
    public ResponseEntity<Goods> updateGoods(@RequestBody Goods goods) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, goods.getId().toString()))
            .body(result);
    }
